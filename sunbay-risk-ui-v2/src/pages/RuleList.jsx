      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="border border-border p-4 mb-6">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-[11px] text-muted tracking-[0.05em] uppercase font-medium">Risk Score Formula</h3>
            <span className="text-[12px] text-muted font-mono">risk_score = Σ (hit rules × score_weight)</span>
          </div>
          ...
          <div className="flex items-center gap-4 mb-2 text-[13px]">
            ...
            <span className="text-muted ml-auto">Max Possible: <span className="font-mono font-medium">{maxScore}</span></span>
          </div>
        ...
        {grouped.map(g => (
          <div key={g.key} className="mb-6">
            <div className="flex items-center gap-2 mb-2">
              ...
              {g.key === 'Platform' && <span className="text-[11px] text-muted">🔒 Read-only for tenants</span>}
            </div>
            <table className="w-full text-[13px]">
              ...
              <tbody>{g.rules.map(r => (
                <tr key={r.id} className="border-b border-border/50 hover:bg-surface cursor-pointer" onClick={() => nav(`/rules/edit/${r.id}`)}>
