...
const ips = ['45.33.32.156','185.220.101.34','91.219.236.174','203.0.113.42','198.51.100.7','77.247.181.163','104.244.76.13','62.210.105.116']
...
const devicePool = [
  ...
  { device_id:'dev_pos_002', device_category:'CERTIFIED_POS', acceptance_method:'TRADITIONAL', manufacturer:'PAX', model:'A920', firmware_version:'2.8.5', pts_cert_expiry:'2027-12-31', tamper_detected:false, serial_number:'PAX-A920-20240015' },
