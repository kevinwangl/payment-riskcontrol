...
export const rules = [
  ...
  { id:'P001', name:'OFAC Sanctions Block', tenant:'Platform', tenantId:'PLATFORM', priority:1, entryMode:'ALL', conditions:[{field:"blacklist('card_hash')", op:'==', value:'true'}], logic:'AND', action:{decision:'DECLINE',suggestions:[]}, reasonCode:'OFAC_HIT', enabled:true, version:3, hitCount:4201, createdAt:'2025-06-01', updatedAt:'2026-03-15' },
  { id:'P002', name:'Single Txn Limit Exceeded', tenant:'Platform', tenantId:'PLATFORM', priority:2, entryMode:'ALL', conditions:[{field:'txn.amount', op:'>', value:'merchant.single_txn_limit'}], logic:'AND', action:{decision:'DECLINE',suggestions:[]}, reasonCode:'LIMIT_EXCEEDED', enabled:true, version:1, hitCount:942, createdAt:'2025-06-01', updatedAt:'2025-06-01' },
  { id:'P003', name:'Frozen Merchant Block', tenant:'Platform', tenantId:'PLATFORM', priority:3, entryMode:'ALL', conditions:[{field:'merchant.status', op:'IN', value:"['FROZEN','SUSPENDED']"}], logic:'AND', action:{decision:'DECLINE',suggestions:[]}, reasonCode:'MERCHANT_FROZEN', enabled:true, version:1, hitCount:156, createdAt:'2025-06-01', updatedAt:'2025-06-01' },
  { id:'P004', name:'High Amount Foreign CNP', tenant:'Platform', tenantId:'PLATFORM', priority:5, entryMode:'CNP', conditions:[{field:'txn.amount', op:'>', value:'5000'}, {field:'card.issuer_country', op:'!=', value:'US'}], logic:'AND', action:{decision:'DECLINE',suggestions:[]}, reasonCode:'HIGH_AMT_FOREIGN_CNP', enabled:true, version:2, hitCount:1834, createdAt:'2025-06-01', updatedAt:'2026-01-10' },
  { id:'P005', name:'Card Testing Attack', tenant:'Platform', tenantId:'PLATFORM', priority:4, entryMode:'ALL', conditions:[{field:"velocity('merchant_id','5m')", op:'>', value:'20'}, {field:'avg_amount', op:'<', value:'2'}], logic:'AND', action:{decision:'DECLINE',suggestions:[]}, reasonCode:'CARD_TESTING', enabled:true, version:1, hitCount:612, createdAt:'2025-08-15', updatedAt:'2025-08-15' },
  { id:'P006', name:'Multi-Card Same IP', tenant:'Platform', tenantId:'PLATFORM', priority:6, entryMode:'CNP', conditions:[{field:"link_count('ip','card','10m')", op:'>', value:'5'}], logic:'AND', action:{decision:'DECLINE',suggestions:[]}, reasonCode:'FRAUD_FACTORY', enabled:true, version:1, hitCount:389, createdAt:'2025-09-01', updatedAt:'2025-09-01' },
  { id:'P007', name:'Greylist Risk Uplift', tenant:'Platform', tenantId:'PLATFORM', priority:10, entryMode:'ALL', conditions:[{field:"greylist('card_hash')", op:'==', value:'true'}, {field:"greylist('ip')", op:'==', value:'true'}], logic:'OR', action:{decision:'DECLINE',suggestions:[]}, reasonCode:'GREYLIST_HIT', enabled:true, version:1, hitCount:2105, createdAt:'2025-06-01', updatedAt:'2025-06-01' },
  { id:'P008', name:'High Risk BIN Decline', tenant:'Platform', tenantId:'PLATFORM', priority:15, entryMode:'ALL', conditions:[{field:'card.bin', op:'IN', value:"['601100','601101','540500']"}, {field:'txn.amount', op:'>', value:'500'}], logic:'AND', action:{decision:'DECLINE',suggestions:[]}, reasonCode:'HIGH_RISK_BIN', enabled:true, version:2, hitCount:1456, createdAt:'2025-07-01', updatedAt:'2026-02-20' },

  // === ISO Level (10) ===
  { id:'I001', name:'Card Velocity 1h > 5', tenant:'ISO', tenantId:'ISO_2001', priority:20, entryMode:'ALL', conditions:[{field:"velocity('card_number','1h')", op:'>', value:'5'}], logic:'AND', action:{decision:'DECLINE',suggestions:['REQUIRE_3DS']}, reasonCode:'CARD_VELOCITY', enabled:true, version:4, hitCount:3210, createdAt:'2025-07-15', updatedAt:'2026-03-20' },
  { id:'I002', name:'Card Amount 24h > $10K', tenant:'ISO', tenantId:'ISO_2001', priority:22, entryMode:'ALL', conditions:[{field:"velocity_amount('card_number','24h')", op:'>', value:'10000'}], logic:'AND', action:{decision:'DECLINE',suggestions:[]}, reasonCode:'CARD_AMT_VELOCITY', enabled:true, version:2, hitCount:876, createdAt:'2025-08-01', updatedAt:'2026-01-15' },
  { id:'I003', name:'Multi-Card Same Device', tenant:'ISO', tenantId:'ISO_2001', priority:25, entryMode:'CNP', conditions:[{field:"link_count('device','card','1h')", op:'>', value:'3'}], logic:'AND', action:{decision:'DECLINE',suggestions:[]}, reasonCode:'DEVICE_MULTI_CARD', enabled:true, version:1, hitCount:543, createdAt:'2025-09-10', updatedAt:'2025-09-10' },
  { id:'I004', name:'Card Multi-Merchant Sweep', tenant:'ISO', tenantId:'ISO_2001', priority:18, entryMode:'ALL', conditions:[{field:"link_count('card','merchant','1h')", op:'>', value:'5'}], logic:'AND', action:{decision:'DECLINE',suggestions:[]}, reasonCode:'CARD_SWEEP', enabled:true, version:1, hitCount:234, createdAt:'2025-10-01', updatedAt:'2025-10-01' },
  { id:'I005', name:'AVS Fail + High Amount', tenant:'ISO', tenantId:'ISO_2001', priority:30, entryMode:'CNP', conditions:[{field:'avs_result', op:'==', value:'N'}, {field:'txn.amount', op:'>', value:'1000'}], logic:'AND', action:{decision:'DECLINE',suggestions:['REQUIRE_3DS']}, reasonCode:'AVS_FAIL_HIGH', enabled:true, version:3, hitCount:1678, createdAt:'2025-07-15', updatedAt:'2026-03-01' },
  { id:'I006', name:'CVV Mismatch Block', tenant:'ISO', tenantId:'ISO_2002', priority:15, entryMode:'CNP', conditions:[{field:'cvv_result', op:'==', value:'N'}], logic:'AND', action:{decision:'DECLINE',suggestions:[]}, reasonCode:'CVV_FAIL', enabled:true, version:1, hitCount:2890, createdAt:'2025-06-15', updatedAt:'2025-06-15' },
  { id:'I007', name:'Off-Hours Restaurant', tenant:'ISO', tenantId:'ISO_2001', priority:40, entryMode:'ALL', conditions:[{field:'txn.hour', op:'<', value:'6'}, {field:'txn.amount', op:'>', value:'500'}, {field:'merchant.mcc', op:'==', value:'5812'}], logic:'AND', action:{decision:'DECLINE',suggestions:[]}, reasonCode:'OFF_HOURS', enabled:true, version:1, hitCount:89, createdAt:'2025-11-01', updatedAt:'2025-11-01' },
  { id:'I008', name:'Restaurant Over $300', tenant:'ISO', tenantId:'ISO_2002', priority:45, entryMode:'ALL', conditions:[{field:'merchant.mcc', op:'==', value:'5812'}, {field:'txn.amount', op:'>', value:'300'}], logic:'AND', action:{decision:'DECLINE',suggestions:[]}, reasonCode:'MCC_CONTEXT', enabled:true, version:1, hitCount:456, createdAt:'2025-11-15', updatedAt:'2025-11-15' },
  { id:'I009', name:'New Merchant Strict Mode', tenant:'ISO', tenantId:'ISO_2001', priority:35, entryMode:'ALL', conditions:[{field:'merchant.age_days', op:'<', value:'90'}, {field:'txn.amount', op:'>', value:'1000'}], logic:'AND', action:{decision:'DECLINE',suggestions:['REQUIRE_3DS']}, reasonCode:'NEW_MERCHANT', enabled:true, version:2, hitCount:312, createdAt:'2025-08-01', updatedAt:'2026-02-01' },
  { id:'I010', name:'Prepaid Card High Amount', tenant:'ISO', tenantId:'ISO_2001', priority:38, entryMode:'ALL', conditions:[{field:'card.type', op:'==', value:'PREPAID'}, {field:'txn.amount', op:'>', value:'500'}], logic:'AND', action:{decision:'DECLINE',suggestions:[]}, reasonCode:'PREPAID_HIGH', enabled:true, version:1, hitCount:198, createdAt:'2025-12-01', updatedAt:'2025-12-01' },

  // === Merchant Level (7) ===
  { id:'M001', name:'Custom Single Limit $2K', tenant:'Merchant', tenantId:'M_1001', priority:50, entryMode:'ALL', conditions:[{field:'txn.amount', op:'>', value:'2000'}], logic:'AND', action:{decision:'DECLINE',suggestions:[]}, reasonCode:'CUSTOM_LIMIT', enabled:true, version:1, hitCount:67, createdAt:'2026-01-15', updatedAt:'2026-01-15' },
  { id:'M002', name:'US Cards Only', tenant:'Merchant', tenantId:'M_1001', priority:48, entryMode:'ALL', conditions:[{field:'card.issuer_country', op:'!=', value:'US'}], logic:'AND', action:{decision:'DECLINE',suggestions:[]}, reasonCode:'NON_US_CARD', enabled:true, version:1, hitCount:234, createdAt:'2026-01-15', updatedAt:'2026-01-15' },
  { id:'M003', name:'Force 3DS All CNP', tenant:'Merchant', tenantId:'M_1002', priority:60, entryMode:'CNP', conditions:[{field:'txn.entry_mode', op:'==', value:'CNP'}], logic:'AND', action:{decision:'APPROVE',suggestions:['REQUIRE_3DS']}, reasonCode:'FORCE_3DS', enabled:true, version:1, hitCount:5670, createdAt:'2026-02-01', updatedAt:'2026-02-01' },
  { id:'M004', name:'VIP Whitelist Pass', tenant:'Merchant', tenantId:'M_1002', priority:1, entryMode:'ALL', conditions:[{field:"whitelist('card_hash')", op:'==', value:'true'}], logic:'AND', action:{decision:'APPROVE',suggestions:[]}, reasonCode:'WHITELIST', enabled:true, version:1, hitCount:890, createdAt:'2026-01-01', updatedAt:'2026-01-01' },
  { id:'M005', name:'CP Large Amount PIN', tenant:'Merchant', tenantId:'M_1003', priority:55, entryMode:'CP', conditions:[{field:'txn.entry_mode', op:'==', value:'CP'}, {field:'txn.amount', op:'>', value:'5000'}], logic:'AND', action:{decision:'APPROVE',suggestions:['REQUIRE_PIN']}, reasonCode:'CP_LARGE', enabled:true, version:1, hitCount:45, createdAt:'2026-02-15', updatedAt:'2026-02-15' },
  { id:'M006', name:'Cross-Region CP Alert', tenant:'Merchant', tenantId:'M_1003', priority:52, entryMode:'CP', conditions:[{field:"geo_distance(txn.terminal_location, card.last_location)", op:'>', value:'500'}], logic:'AND', action:{decision:'DECLINE',suggestions:[]}, reasonCode:'CROSS_REGION', enabled:true, version:1, hitCount:23, createdAt:'2026-03-01', updatedAt:'2026-03-01' },
  { id:'M007', name:'Repeated Same Amount', tenant:'Merchant', tenantId:'M_1001', priority:58, entryMode:'ALL', conditions:[{field:"same_amount_count('card_number','1h')", op:'>', value:'3'}], logic:'AND', action:{decision:'DECLINE',suggestions:[]}, reasonCode:'SAME_AMOUNT', enabled:true, version:1, hitCount:12, createdAt:'2026-03-10', updatedAt:'2026-03-10' },
]
